...
},{"./source/input-field.js":"ef5xA","./source/game-field.js":"cLWOP","./source/pop-up.js":"2aj5p","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ef5xA":[function(require,module,exports) {
/*============================================================================
  InputField
...
class GameField extends HTMLElement {
    ...
    init() {
        ...
        for(let i = 0; i < 6; i++)this.answerArray.push(Math.floor(Math.random() * 6) + 1);
    ...
    winHandler() {
        ...
        guessArray.forEach((input, index)=>{
            ...
            } else if (solutionArray.includes(guess)) currentField.children[index].classList.add("input--close");
            else currentField.children[index].classList.add("input--wrong");
            console.log(this.currentTurn);
            if (this.currentTurn <= 7) (0, _utilsJs.dispatchEvent)("game:lose");
        });
    }
}
...
},{}]},["7ZoMj","8lRBv"], "8lRBv", "parcelRequire549c")
